...
module tb_final_comprehensive;
    ...
    task run_single_test;
        ...
        begin
            ...
            // Make sure FSM is idle
            wait(!nmp_active && !inter_flag);
    ...
    initial begin
        ...
        $display("Array Sizes:");
        run_single_test("1 element",   17'h0001, 5'd1,  32'h1000, 32'h2000, 32'h3000, 32'h100, 32'h1000);
        run_single_test("2 elements",  17'h0002, 5'd2,  32'h1000, 32'h2000, 32'h3000, 32'h200, 32'h2000);
        run_single_test("4 elements",  17'h0003, 5'd4,  32'h1000, 32'h2000, 32'h3000, 32'h300, 32'h3000);
        run_single_test("8 elements",  17'h0004, 5'd8,  32'h1000, 32'h2000, 32'h3000, 32'h400, 32'h4000);
        run_single_test("16 elements", 17'h0005, 5'd16, 32'h1000, 32'h2000, 32'h3000, 32'h500, 32'h5000);
        run_single_test("31 elements", 17'h0006, 5'd31, 32'h1000, 32'h2000, 32'h3000, 32'h600, 32'h6000);
        
        $display("\nData Patterns:");
        run_single_test("All zeros",   17'h0010, 5'd4,  32'h1000, 32'h2000, 32'h3000, 32'h000, 32'h000);
        run_single_test("Small nums",  17'h0011, 5'd4,  32'h1000, 32'h2000, 32'h3000, 32'h1, 32'h2);
        run_single_test("Large nums",  17'h0012, 5'd4,  32'h1000, 32'h2000, 32'h3000, 32'hFFFF0000, 32'hFFFF);
        run_single_test("Max+1",       17'h0013, 5'd2,  32'h1000, 32'h2000, 32'h3000, 32'hFFFFFFFF, 32'h1);
        
        $display("\nOdd Sizes:");
        run_single_test("3 elements",  17'h0020, 5'd3,  32'h1000, 32'h2000, 32'h3000, 32'h30, 32'h300);
        run_single_test("5 elements",  17'h0021, 5'd5,  32'h1000, 32'h2000, 32'h3000, 32'h50, 32'h500);
        run_single_test("7 elements",  17'h0022, 5'd7,  32'h1000, 32'h2000, 32'h3000, 32'h70, 32'h700);
        run_single_test("15 elements", 17'h0023, 5'd15, 32'h1000, 32'h2000, 32'h3000, 32'hF0, 32'hF00);
